...
namespace InventorySaaS_Backend.Migrations
{
    ...
    [Migration("20260212224119_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventorySaaSBackend.Models.DocumentoDetalle", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdDocumentoDetalle"));
                    ...
                    b.ToTable("documento_detalle", t =>
                        {
                            t.HasCheckConstraint("CK_DocumentoDetalle_Cantidad", "cantidad > 0");
                        });
                });

            modelBuilder.Entity("InventorySaaSBackend.Models.Documentos", b =>
                {
                    b.Property<int>("IdDocumento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Documentos", t =>
                        {
                            t.HasCheckConstraint("CK_Documentos_Estado", "estado IN ('BORRADOR', 'CONFIRMADO')");
                        });
                });
            ...
            modelBuilder.Entity("InventorySaaSBackend.Models.DocumentoDetalle", b =>
                {
                    ...
                    b.HasOne("InventorySaaSBackend.Models.Documentos", null)
                        .WithMany()
